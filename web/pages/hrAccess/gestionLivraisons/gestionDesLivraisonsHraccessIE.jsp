...
<html:form action="/exporterPackHraccessForm" styleId="exporterPackHraccessForm">
    ...
    <table class="tablePrincipale">
        ...
        <tr class="numLivraisonDiv groupe0">
            ...
            <td  class="tdDemi">
                <p class="contenu">
                    ...
                    <input type="button" class="boutonValiderPetit" id="resetLivraisonsList" onclick="window.location = './getAllTicketsHraccessForm.do?acteur=IEHR'" style="margin-left: 10px" value="Réinitialiser" />
                </p>
            </td>
        </tr>
        <tr class="groupe1">
        ...
        <tr class="groupe1">
            <td  class="tdDemi"><p class="titres">Status</p></td>
            <td  class="tdDemi">
                <p class="contenu">                       
                    <html:text styleClass="readonly" styleId="status" property="status" style="width:310px;margin-left: 5px;"/>
                </p>
            </td>
        </tr>
                                        ...
                                        <%  int cmp = 1;
                                            ...
                                            if (listHotfixHarmRelease == null || listHotfixHarmRelease.size() == 0) {
                                                ...
                                                for (Map<String, Object> mapDetails : listHotfixHarmRelease) {
                                                    ...
                                                    out.println("<tr" + Tools.traiterClignotantLivraisonEnCours(numTicket.toString()) + "><td>" + cmp + ")</td><td ><a class='lien' onclick='preparerLivraisonHraccess($(this).html());'>#" + numTicket + "</a></td><td>" + mapDetails.get("deliveryTime") + "</td><td>" + mapDetails.get("responsable") + "</td><td>" + mapDetails.get("owner") + "</td></tr>");
                                                    cmp++;
                                                }
                                            }
...
<script>
                        ...
                        function preparerLivraisonHraccess(idTicket) {
                            idTicket = idTicket.replace(/#/g, "");
                            $("#numLivraison").val(idTicket);
                            //$("#getLivraisonDetails").click();
                            openTracTicketHraccessInNewTab(idTicket);
                        }
