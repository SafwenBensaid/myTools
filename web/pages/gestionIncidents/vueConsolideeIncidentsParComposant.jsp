...
<div class='grandTitre'>
    Vue consolidée: Gestion des Incidents SI par Composant
</div>
...
<script>
    ...
    function loadAllTicketsTable() {
        ...
        $.ajax({
            type: "POST",
            url: contextPath + "/GenererVueConsolideeIncidentsServlet?param=composant",
    ...
    $(document).ready(function() {
        selectMenu('menuVueConsolidéeIncidents');
    });
