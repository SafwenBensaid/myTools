        ...
        <td class="cadre" colspan="3">
            ...
            <div class="divtab">
                <table class="envtab">
                    <thead>
                        <tr>
                            <th class="cadreThBlanc"><a href="http://172.28.70.246/trac/prospection_tre" target="_blank"> <img src="images/tracProspectionTre.png" class="btnTrac1" style="margin: 0"/></a></th>
...
<script>
    $(document).ready(function() {
        selectMenu('menuPROSPECTION_TRE');
    });
</script>