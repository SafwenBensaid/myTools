        ...
        <td class="cadre" colspan="3">
            ...
            <div class="divtab">
                <table class="envtab">
                    <thead>
                        <tr>
                            <th class="cadreThBlanc"><a href="http://172.28.70.246/trac/gestion_courrier" target="_blank"> <img src="images/tracGestionCourrier.png" class="btnTrac1" style="margin: 0"/></a></th>
...
<script>
    $(document).ready(function() {
        selectMenu('menuGESTION_COURRIER');
    });
</script>