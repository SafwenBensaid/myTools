        ...
        <td class="cadre" colspan="3">
            ...
            <div class="divtab">
                <table class="envtab">
                    <thead>
                        <tr>
                            <th class="cadreThBlanc"><a href="http://172.28.70.74/trac/BFI_TITRE" target="_blank"> <img src="images/tracBfiTitre.png" class="btnTrac1" style="margin: 0"/></a></th>
