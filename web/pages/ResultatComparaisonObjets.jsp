...
<div class="centre">
    ...
    <span id="resultatAnalysePack">
        Le pack <b><%= champs.getPackName()%></b> a été téléchargé depuis les environnements <%= champs.getEnvironnementSourceName()%> et <%= champs.getEnvironnementDestinationName()%>.
    </span>          
    <p class="conteneurBouton">
        <input type="button" class="boutonValider"  value="Annuler" onclick="document.location.href = './PreparationComparaisonObjetsForm.do';" />
