...
<div class='grandTitre'>
    Vue consolidée: Gestion des Demandes Métier par Domaine
</div>
...
<script>
    ...
    function loadAllTicketsTable() {
        ...
        $.ajax({
            type: "POST",
            url: contextPath + "/GenererVueConsolideeDemandesServlet?param=composant",
    ...
    $(document).ready(function() {
        selectMenu('menuVueConsolidéeDemandes');
    });
