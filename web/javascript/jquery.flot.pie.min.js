        ...
        function K(Q) {
            ...
            for (var O = 0; O < Q.length; ++O) {
                ...
                if (Q[O].data[0][1] / M <= a.series.pie.combine.threshold) {
                    ...
                    R.push({data: [[1, Q[O].data[0][1]]], color: Q[O].color, label: Q[O].label, angle: (Q[O].data[0][1] * (Math.PI * 2)) / M, percent: (Q[O].data[0][1] / M * 100), nbrElmnts: Q[O].data[0][1], nbrGlobal: M})
                }
            }
            if (S > 0) {
                R.push({data: [[1, P]], color: N, label: a.series.pie.combine.label, angle: (P * (Math.PI * 2)) / M, percent: (P / M * 100), nbrElmnts: Q[O].data[0][1], nbrGlobal: M})
            }
            return R
        }
        function r(S, Q) {
