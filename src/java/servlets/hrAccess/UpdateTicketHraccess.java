 ...
 * @author 04486
 */
public class UpdateTicketHraccess extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String pu = Configuration.puHraccess;
            ...
            String resultat = DataBaseTracGenericRequests.updateTicketTracGeneral(pu, numTicket, connectedUser, messageTrac, newOwner, newPriority, newStatus, newVersion, customFieldList);
            out.print(resultat);
        } finally {
            out.close();
        }
